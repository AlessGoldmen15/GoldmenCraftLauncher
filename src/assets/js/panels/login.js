...
class Login {
    ...
    setupOptions() {
        document.querySelectorAll(".back.back-home").forEach((e) => {
            e.addEventListener("click", () => {
                document.querySelector(".login-list").style.display = "block";
                document.querySelectorAll(".login-tabs").forEach((e) => {
                    e.style.display = "none";
                });
            });
        });
        Array.from(document.querySelector(".login-btn-list").children).forEach(
            (child) => {
                child.addEventListener("click", () => {
                    document.querySelector(".login-list").style.display =
                        "none";
    ...
    async getAZauth() {
        console.log("Initializing AZ login...");
